<?php session_start();
   ...
   // Add User Starts Here
      ...
      $fada = get_data_id_data("users", "id",$data['user_id'] );
      $email = $fada['email'];
      $curl = curl_init();

      curl_setopt_array($curl, array(
        CURLOPT_URL => 'http://3.21.231.199:3001/smtp/forGmail',
      ...
      $headers= "From: Contact Enquiry<website@obortech.io>\r\n";
      $headers.= "Reply-To: KYC <kishan@obortech.io>\r\n";
      $headers.= "X-Mailer: PHP/" . phpversion()."\r\n";
      $headers.= "MIME-Version: 1.0" . "\r\n";
      $headers.= "Content-type: text/html; charset=iso-8859-1\r\n";

      //mail($to, $subject, $dara, $headers);
